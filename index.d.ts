...
/* eslint-disable */
export declare function compress(data: string | Buffer, dict?: string | Buffer | undefined | null): Promise<Buffer> | Promise<Buffer>
...
export declare function uncompress(data: string | Buffer, dict?: string | Buffer | undefined | null): Promise<Buffer> | Promise<Buffer>
